...
from app.module.user.infrastructure.repositories.user_read_sql_alchemy_repository import (
    UserReadSqlAlchemyRepository,
)
from app.module.user.infrastructure.repositories.user_write_sql_alchemy_repository import (
    UserWriteSqlAlchemyRepository,
)
...
def get_delete_user_use_case(
    ...
    return DeleteUserUseCase(read_repo, write_repo)
